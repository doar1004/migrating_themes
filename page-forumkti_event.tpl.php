...
<link rel="stylesheet" href="<?php print $base_url . $base_path; ?>sites/all/themes/bakti/timeline/js/tipsy/tipsy.css" type="text/css">
<link rel="stylesheet" href="<?php print $base_url . $base_path; ?>sites/all/themes/bakti/timeline/js/prettyPhoto/css/prettyPhoto.css" type="text/css" media="all">
<link rel="stylesheet" href="<?php print $base_url . $base_path; ?>sites/all/themes/bakti/timeline/js/jquery/m.css" type="text/css" media="all">
<script src="<?php print $base_url . $base_path; ?>sites/all/themes/bakti/timeline/js/jquery/jquery-1.7.1.min.js"></script>
<script src="<?php print $base_url . $base_path; ?>sites/all/themes/bakti/timeline/js/jquery/jquery-ui-1.8.18.custom.min.js"></script>
<script src="<?php print $base_url . $base_path; ?>sites/all/themes/bakti/timeline/js/jquery/jquery.ui.touch-punch.js"></script>
<script src="<?php print $base_url . $base_path; ?>sites/all/themes/bakti/timeline/js/prettyPhoto/js/jquery.prettyPhoto.js"></script>
<script src="<?php print $base_url . $base_path; ?>sites/all/themes/bakti/timeline/js/tipsy/jquery.tipsy.js"></script>
<script src="<?php print $base_url . $base_path; ?>sites/all/themes/bakti/timeline/js/audiojs/audio.min.js"></script>
<script src="<?php print $base_url . $base_path; ?>sites/all/themes/bakti/timeline/js/jquery/s.js"></script>
<script src="<?php print $base_url . $base_path; ?>sites/all/themes/bakti/timeline/js/jquery/m.js"></script>
<!-- end timeline><!-->
